...
func buildFileKeys() []fileKey {
	return []fileKey{
		...
		{"ldflags", "ldflags", func(c buildconfig.Config, _ string) { ldflags = c.LDFlags }},
		{"tags", "tags", func(c buildconfig.Config, _ string) { tags = c.Tags }},
		{"trimpath", "trimpath", func(c buildconfig.Config, _ string) { trimpath = c.TrimPath }},
		{"gcflags", "gcflags", func(c buildconfig.Config, _ string) { gcflags = c.GCFlags }},
		{"asmflags", "asmflags", func(c buildconfig.Config, _ string) { asmflags = c.ASMFlags }},
