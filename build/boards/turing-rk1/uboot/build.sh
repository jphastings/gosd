#!/usr/bin/env bash
# Builds mainline U-Boot for the Turing RK1, inside Docker, and writes the
# artifacts to ./out/.
#
# Usage: ./build.sh
#
# Pinned inputs (edit here / in manifest.json to bump versions):
#   - U-Boot release tag: UBOOT_TAG below.
...
IMAGE_TAG="gosd-turing-rk1-uboot-build"
...
echo "Building U-Boot ${UBOOT_TAG} for turing-rk1 (rkbin @ ${RKBIN_COMMIT:0:12})..."
