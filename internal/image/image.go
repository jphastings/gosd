...
type Spec struct {
	...
	// file, or into a reserved gosd.toml, without any FAT tooling (see
	// internal/inject and docs/image-injection.md). Every entry must be a
	// key of BootFiles; Write checks this up front, before any image bytes
	// exist.
	ReportRanges []string
}
