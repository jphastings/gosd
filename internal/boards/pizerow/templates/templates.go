// Package templates holds the Pi Zero W boot partition text files
...
//
// The content of both templates is locked by bean gosd-06kj; do not change
// it without updating that decision. ConfigTxtData.UsbGadget (mirroring
// pi-zero-2w's gosd-uo9f) is an additive exception: it only ever appends a
// line, never changing what renders when it's unset.
package templates
