...
const wantExtlinuxConf = "default gosd\n" +
	...
	"    append console=ttyS9,115200n8 quiet init=/init gosd.board=turing-rk1 panic=10\n"
...
func TestRenderExtlinuxConf_ConsoleBaudOverride(t *testing.T) {
	...
	want := "    append console=ttyS9,1500000n8 quiet init=/init gosd.board=turing-rk1 panic=10\n"
...
func TestRenderExtlinuxConf_KernelParams(t *testing.T) {
	...
	want := "    append console=ttyS9,115200n8 quiet init=/init gosd.board=turing-rk1 panic=10 foo=bar baz\n"
	if !strings.Contains(got, want) {
