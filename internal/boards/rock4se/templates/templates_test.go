...
// Locked content, per bean gosd-je2r: do not change this expectation without
...
func TestRenderExtlinuxConf_ConsoleBaudOverride(t *testing.T) {
	...
	want := "    append console=ttyS2,115200n8 quiet init=/init gosd.board=rock-4se panic=10\n"
