...
updated_at: 2026-08-07T15:07:29Z
---
...
Completed 2026-08-07 during backlog triage: overtaken by events — internal/artifacts.Version is v0.8.0 on main (the v0.6.0 bump this bean tracked happened and was itself superseded by the v0.7.0/v0.8.0 releases; the three-way verification todos above were already checked).
